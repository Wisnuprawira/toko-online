			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="frontend/img/ist.png" alt="">
						</a>
					</div>
					<!-- /footer logo -->

					<p>Istana Sepatu Tangsel PASTI ORIGINAL.</p>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center">
				...
				<div class="footer-copyright">
					...
					Istana Sepatu &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved
